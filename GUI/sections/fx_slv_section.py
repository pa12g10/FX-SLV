...
FX_OPTION_INSTRUMENTS = pd.DataFrame({
    ...
    "Market Vol (%)":[6.90, 6.50, 6.20, 6.55, 7.00,   # 1W  - 10D Call +0.15
                      7.20, 6.80, 6.50, 6.75, 7.30,   # 1M  - 10D Call +0.15
                      7.95, 7.30, 6.90, 7.25, 7.90,   # 3M  - 10D Put  +0.15
                      8.25, 7.60, 7.28, 7.55, 8.10,   # 6M  - ATM +0.08, 10D Put +0.15
                      8.50, 7.89, 7.55, 7.90, 8.45,   # 1Y  - 25D Put  -0.06
                      9.10, 8.40, 8.00, 8.35, 9.10],  # 2Y  - 10D Call +0.15
    "Bid Vol (%)":   [6.70, 6.32, 6.04, 6.38, 6.81,
                      7.00, 6.63, 6.34, 6.58, 7.11,
                      7.73, 7.10, 6.72, 7.07, 7.70,
                      8.03, 7.39, 7.09, 7.36, 7.89,
                      8.26, 7.67, 7.33, 7.68, 8.22,
                      8.84, 8.16, 7.76, 8.11, 8.85],
    "Ask Vol (%)":   [7.10, 6.68, 6.36, 6.72, 7.19,
                      7.40, 6.97, 6.66, 6.92, 7.49,
                      8.17, 7.50, 7.08, 7.43, 8.10,
                      8.47, 7.81, 7.47, 7.74, 8.31,
                      8.74, 8.11, 7.77, 8.12, 8.68,
                      9.36, 8.64, 8.24, 8.59, 9.35],
